                        ...
                        <div class="row">
                        	<?php 
                                ...
                                <div class="form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                    {!! Form::label('state_id', trans('Select City')) !!}
                                        <select class="form-control" name="city_id"  >
                                           ...
                                           <option value="">---{{ $areas[0]->city_name }}---</option>
                             ...
                             <div class="col-sm-4">
                              ...
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('gaurage_name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('gaurage_name', old('gaurage_name',$stores->gaurage_name), ['class' => 'form-control', 'placeholder' => trans('Store Name')]) !!}
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('address', old('address',$stores->address), ['class' => 'form-control', 'placeholder' => trans('Address')]) !!}
                              ...
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('lat') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('lat', old('lat',$stores->lat), ['class' => 'form-control', 'placeholder' => trans('Lattitude')]) !!}
                              ...
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('longi') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('longi', old('longi',$stores->longi), ['class' => 'form-control', 'placeholder' => trans('Longitude')]) !!}
                             ...
                             <div class="col-sm-4">
                                ...
                                <iframe src="{{ URL::asset($stores->price) }}">
</iframe>
                            </div>
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                                    {!! Form::label('phone_number', trans('Phone Number')) !!}
                                    {!! Form::text('phone_number', old('phone_number',$stores->phone_number), ['class' => 'form-control', 'placeholder' => trans('Phone Number')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('aphone_number') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('aphone_number', old('aphone_number',$stores->aphone_number), ['class' => 'form-control', 'placeholder' => trans('Alternate Contact')]) !!}
                        ...
                        <h2>Owner Details</h2>
                            <div class="row">
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('first_name', old('first_name',$stores->first_name), ['class' => 'form-control', 'placeholder' => trans('First Name')]) !!}
                              ...
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('last_name', old('last_name',$stores->last_name), ['class' => 'form-control', 'placeholder' => trans('First Name')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('email', old('email',$stores->email), ['class' => 'form-control', 'placeholder' => trans('Email')]) !!}
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('password', old('password',$stores->password), ['class' => 'form-control', 'placeholder' => trans('Password')]) !!}
