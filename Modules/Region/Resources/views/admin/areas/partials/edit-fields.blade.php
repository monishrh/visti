                            ...
                            <div class="col-sm-4">
                              <div class="form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                    {!! Form::label('city_id', trans('Select City')) !!}
                                        <select class="form-control" name="city_id"  >
                                          <?php 
                                    $areas = DB::table('region__cities')->where('id', '=',$area->id)->get();
                                 ?>
                         
                                           <option value="{{$areas[0]->id}}">---{{ $areas[0]->city_name }}---</option>
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('area_name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('area_name', old('area_name',$area->area_name ), ['class' => 'form-control', 'placeholder' => trans('Area Name')]) !!}
