                        ...
                        <div class="row">
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::number('city_id', old('city_id',$city->city_id), ['class' => 'form-control', 'placeholder' => trans('City ID')]) !!}
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('city_name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('city_name', old('city_name',$city->city_name), ['class' => 'form-control', 'placeholder' => trans('City Name')]) !!}
