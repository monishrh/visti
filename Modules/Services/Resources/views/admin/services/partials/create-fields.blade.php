    ...
    <p>
      <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => trans('Service Name ')]) !!}
                              ...
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('description', old('description'), ['class' => 'form-control', 'placeholder' => trans('Description')]) !!}
                               ...
                               <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('service_charge') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('service_charge', old('service_charge'), ['class' => 'form-control', 'placeholder' => trans('Service Charge')]) !!}
                               ...
                               <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('minimum_charge') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('minimum_charge', old('minimum_charge'), ['class' => 'form-control', 'placeholder' => trans('Minimum Charges')]) !!}
