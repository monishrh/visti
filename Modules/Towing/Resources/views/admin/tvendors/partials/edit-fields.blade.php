                       ...
                       <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
                                    {!! Form::label('state_id', trans('Select City')) !!}
                                        <select class="form-control" name="city_id"  >
                                           ...
                                           <option value="">--- {{ $tvendors->city_id }}---</option>
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('name', old('name',$tvendors->name), ['class' => 'form-control', 'placeholder' => trans('Vendor Name')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('email', old('email',$tvendors->email), ['class' => 'form-control', 'placeholder' => trans('Email')]) !!}
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('phone', old('phone',$tvendors->phone), ['class' => 'form-control', 'placeholder' => trans('Phone Number')]) !!}
                            ...
                            <input type="hidden" name="password" value="1234">
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('address', old('address',$tvendors->address), ['class' => 'form-control', 'placeholder' => trans('Address')]) !!}
